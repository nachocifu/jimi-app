...
public class OrderServiceTest {
	...
	public void addDishTest() {
		...
		Order order = new Order(1, OPENEDAT, null, OrderStatus.OPEN, 0);
		
		// Mockito mocking
		Order returnOrder = new Order(1, OPENEDAT, null, OrderStatus.OPEN, 0);
	...
	public void addDishesToInactiveOrderTest() {
		...
		// Mockito mocking
		Order returnOrder = new Order(1, null, null, OrderStatus.INACTIVE, 0);
	...
	public void addDishTwiceTest() {
		...
		// Mockito mocking
		Order returnOrder1 = new Order(1, OPENEDAT, null, OrderStatus.OPEN, 0);
		returnOrder1.setDish(dish, 1);
		
		Order returnOrder2 = new Order(1, OPENEDAT, null, OrderStatus.OPEN, 0);
	...
	public void addDishTwiceThenRemoveOnceTest() {
		...
		Order returnOrder3 = new Order(1, OPENEDAT, null, OrderStatus.OPEN, 0);
	...
	public void addDishTwiceThenRemoveOnceNotOpenOrderTest() {
		...
		Order orderNotOpen = new Order(1, null, null, OrderStatus.INACTIVE, 0);
		...
		Order returnOrder3 = new Order(1, OPENEDAT, null, OrderStatus.INACTIVE, 0);
		returnOrder3.setDish(dish, 1);
	...
	public void addDishTwiceThenRemoveTwiceTest() {
		...
		Order returnOrder4 = new Order(1, OPENEDAT, null, OrderStatus.OPEN, 0);
	...
	public void addDishTwiceThenRemoveAllNotOpenOrderTest() {
		...
		Dish dish = new Dish(DISH_NAME, DISH_PRICE, 1, DISH_STOCK);
		Order order = new Order(1, OPENEDAT, null, OrderStatus.OPEN, 0);
		Order orderNotOpen = new Order(1, OPENEDAT, null, OrderStatus.INACTIVE, 0);
	...
	public void setDinersTest() {
		...
		Assert.assertEquals(5, order.getDiners());
	}
	...
	public void openOrderOnNOTInactiveTest() {
		Order order = new Order(1, null, null, OrderStatus.CLOSED, 0);
